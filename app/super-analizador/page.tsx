export default function SuperAnalizador() {
  return (
    <div style={{ minHeight: "100vh", background: "#0f1419", color: "#fff", fontFamily: "'Inter', sans-serif" }}>
      <nav style={{ background: "#0a0e1a", borderBottom: "1px solid #4CAF5022", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
      ...
      <div style={{ maxWidth: "600px", margin: "80px auto", padding: "0 32px", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: "36px", fontWeight: 900, letterSpacing: "-1px", margin: "0 0 12px 0" }}>
          Super <span style={{ color: "#4CAF50" }}>Analizador</span>
        </h1>
